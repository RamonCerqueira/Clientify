...
export default function HomePage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center gap-8 px-6 text-center">
      ...
      <p className="max-w-2xl text-lg text-slate-600">Autenticação, dashboard, CRM leve e páginas públicas prontos para escalar sua operação de geração de demanda.</p>
