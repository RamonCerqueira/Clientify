  ...
  async create(tenantId: string, dto: CreatePageDto) {
    ...
    return this.prisma.page.create({
      data: {
        ...
        heroHeadline: dto.heroHeadline?.trim() || title,
        heroSubheadline: dto.heroSubheadline?.trim() || dto.description,
        ctaText: dto.ctaText?.trim() || 'Quero atendimento',
        layoutStyle: dto.layoutStyle ?? 'MODERN',
        primaryColor: dto.primaryColor ?? '#22d3ee',
